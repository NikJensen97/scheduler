...
import { getByAltText, getByText, render, cleanup, fireEvent, waitForElement, prettyDOM, getAllByTestId } from "@testing-library/react";
// import "src/__mocks__/axios.js";
...
xit("loads data, edits an interview and keeps the spots remaining for Monday the same", async () => {
  ...
  expect(getAllByTestId(container, "student-name-input")).toBeInTheDocument();
